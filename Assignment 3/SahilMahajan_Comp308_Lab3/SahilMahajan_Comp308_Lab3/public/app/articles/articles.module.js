System.register(["@angular/core", "@angular/common", "@angular/forms", "@angular/router", "./articles.routes", "./articles.component", "./create/create.component", "./list/list.component", "./view/view.component", "./edit/edit.component", "./listAllCourses/listAllCourses.component", "./listAllStudents/listAllStudents.components"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, forms_1, router_1, articles_routes_1, articles_component_1, create_component_1, list_component_1, view_component_1, edit_component_1, listAllCourses_component_1, listAllStudents_components_1, ArticlesModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
                ...
                ArticlesModule = __decorate([
                    core_1.NgModule({
                        ...
                        declarations: [
                            ...
                            listAllStudents_components_1.ListAllStudentsComponent,
                        ]
                    })
                ], ArticlesModule);
