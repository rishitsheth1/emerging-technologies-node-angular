...
exports.listAllStudents = function (req, res, next) {
    ...
    User.find({}, (err, users) => {
        console.log("list All Students finding users*********" + err);
        if (err) {
            console.log("error in finding users*********"+err);
            // Call the next middleware with an error message
            return next(err);
        } else {
            console.log(users+"success in finding users in controller*********" + users.length);
...
exports.signup = function (req, res) {
    ...
    console.log("user in sign up is" + user);
    user.provider = 'local';
